 ...
 * @author Faujixx
 */
public class QualityCheck extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Barang", "Nama Barang", "Pass", "Reject", "Kategori"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jButton9.setText("Total Qc Pass");

        jButton10.setText("Total Qc Reject");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QualityCheck.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QualityCheck().setVisible(true);
            }
        });
    }
